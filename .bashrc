...
poc() {
	curl wttr.in/ceske_budejovice
}
#ggrepv() {
#	GREPPED=`git gr $@`
#	#readarray -t LINES <<<"$GREPPED"
#	IFS=$'\n' LINES=(${GREPPED//$'\n'/ })
#	echo ${#LINES[@]}
#	#LINES_ARR=(`echo ${LINES}`)
#	#read -a LINES_ARR <<<$LINES
#	#echo "${LINES_ARR[0]} * ${LINES_ARR[1]} * ${LINES_ARR[2]}"
...
. ~/rgit/ansible/hacking/env-setup -q
